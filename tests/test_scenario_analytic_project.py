...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        # Activate modules
        activate_modules('analytic_project')
        ...
        self.assertEqual(project.invoiced_amount, Decimal('0.00'))

        # Invoice project up to yesterday
        project.project_invoice_timesheet_up_to = yesterday
        project.save()
        project.click('invoice')
        self.assertEqual(project.amount_to_invoice, Decimal('0.00'))
        self.assertEqual(project.invoiced_amount, Decimal('60.00'))
        project.project_invoice_timesheet_up_to = today
        project.save()
        self.assertEqual(project.amount_to_invoice, Decimal('40.00'))
        ...
        self.assertEqual(len(line1.analytic_accounts), 1)
        analytic_account1, = line1.analytic_accounts
        self.assertEqual((analytic_account1.root, analytic_account1.account),
                         (root, analytic_account))
