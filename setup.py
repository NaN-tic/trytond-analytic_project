...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-analytic_project',
    download_url='https://github.com:nantic/trytond-analytic_project.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-analytic_project.git'
    },
    classifiers=[
